...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    if(camera.position.x+ground.width/2 > ground.x+ground.width/2){
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(windowWidth/2,windowHeight-60,10,40);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(windowWidth/2,120,40,10);
